...
1. Drop some unessential columns [Not needed in the precipitation data] [Frankie code]
```{r}
...
3. Find the average, max, and min precipitation for annual level [Frankie code]
```{r}
...
5. Subset of Monthly Data- 2011-2017 [Frankie code]
```{r}
