...
```
## Added: Max EVI in 2010-2011 and 2016-2017 growing seasons; regional and district levels

```{r}
# Regional 2011

# Max
Grow2011 <- EVI_region_long %>% 
  filter(Month == "05"|Month == "04"|Month =="03"|Month =="02"|Month =="01"|Month =="10"|Month =="11"|Month =="12", 
         Year == 2010:2011) %>% 
  filter(!(Year == 2010 & Month == "03")) %>% 
  filter(!(Year == 2010 & Month == "04")) %>%
  ...
  summarise(AverageEVI = mean(EVI, na.rm = TRUE),
            MaxEVI = max(EVI, na.rm = TRUE),
            SdEVI = sd(EVI, na.rm = TRUE))

EVIGrow2011 <- full_join(zim_region, Grow2011, by = "Region")
...
# Average
AvgEVI2011 <- EVIGrow2011 %>% 
  ggplot() +
  geom_sf(size = 0.15, color = "black", aes(fill = AverageEVI)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  ggtitle("Average EVI in Zimbabwe-Growing Season 2011")

# Standard Deviation
SdEVI2011 <- EVIGrow2011 %>% 
  ggplot() +
  geom_sf(size = 0.15, color = "black", aes(fill = SdEVI)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  ggtitle("Standard Deviation of EVI in Zimbabwe-Growing Season 2011")
...
EVIGrow2017 <- full_join(zim_region, Grow2017, by = "Region")

RgMaxEVI2017 <- EVIGrow2017 %>% 
  ggplot() +
  geom_sf(size = 0.15, color = "black", aes(fill = MaxEVI)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
...
# Average
AvgEVI2017 <- EVIGrow2017 %>% 
  ggplot() +
  geom_sf(size = 0.15, color = "black", aes(fill = AverageEVI)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  ggtitle("Average EVI in Zimbabwe-Growing Season 2017")

# Standard Deviation
SdEVI2017 <- EVIGrow2017 %>% 
  ggplot() +
  geom_sf(size = 0.15, color = "black", aes(fill = SdEVI)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  ggtitle("Standard Deviation of EVI in Zimbabwe-Growing Season 2017")
...
DisEVIGrow2011 <- full_join(zim_district, DisGrow2011, by = "District")

# Max
DisMaxEVI2011 <- DisEVIGrow2011 %>% 
  ggplot() +
  geom_sf(size = 0.15, color = "black", aes(fill = MaxEVI)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
...
DisEVIGrow2017 <- full_join(zim_district, DisGrow2017, by = "District")

# Max
DisMaxEVI2017 <- DisEVIGrow2017 %>% 
  ggplot() +
  geom_sf(size = 0.15, color = "black", aes(fill = MaxEVI)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
