...
```{r}
zim_region_3h_avg_10_11_12_long <- zim_region_3h_avg_10_11_12_long %>% group_by(Date,Region)%>% summarise(dailyPRECIP = sum(Precipitation, na.rm = TRUE))

zim_region_3h_avg_16_17_18_long <- zim_region_3h_avg_16_17_18_long %>% group_by(Date, Region) %>%
summarise(dailyPRECIP = sum(Precipitation, na.rm = TRUE))
