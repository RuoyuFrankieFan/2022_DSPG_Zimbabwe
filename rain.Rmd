...
```{r}
#write.csv(total1011,"./total1011_2.csv", row.names = FALSE)
#write.csv(total1617,"./total1617.csv", row.names = FALSE)

saveRDS(total1011, file = paste0('total1011','.RDS')) #writing RPK_dist_outline to RDS file
saveRDS(total1617, file = paste0('total1617','.RDS'))

saveRDS(totalDec10, file = paste0('totalDec10','.RDS'))
saveRDS(totalJan11, file = paste0('totalJan11','.RDS'))
saveRDS(totalFeb11, file = paste0('totalFeb11','.RDS'))

saveRDS(totalDec16, file = paste0('totalDec16','.RDS'))
saveRDS(totalJan17, file = paste0('totalJan17','.RDS'))
saveRDS(totalFeb17, file = paste0('totalFeb17','.RDS'))
