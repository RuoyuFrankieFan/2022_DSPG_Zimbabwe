...
```{r}
### Here I tried to merge all three dataframes but havent figured out a way yet

LongNDVI <- long_max %>% 
  inner_join(long_mean, by = "District")


NewDataframe <- merge(long_max, long_mean, by=0, all.x=TRUE)

wide_1 <- ProcessedNDVI %>% 
  select(District, AveragePPT2000:MinPPT2021)
```
