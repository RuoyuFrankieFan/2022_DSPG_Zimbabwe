...
mydat_long <- gather(as.data.frame(read_csv("./regional_data/PRECIP3hravg_ts_Zimb (2016-2018).csv")), Date, Precipitation, '3B42_20160101_03_7_precipitation': '3B42_20181231_00_7_precipitation') %>%
...
min <- as.yearmon("201610", "%Y%m")
max <- as.yearmon("201705", "%Y%m")
...
p <- ggplot(sum_g1, aes(x = newDate, y = value, color = variable, group =1)) + 
    ...
    ggtitle("Average Rainfall During the 2016-17 Growing Season") +
