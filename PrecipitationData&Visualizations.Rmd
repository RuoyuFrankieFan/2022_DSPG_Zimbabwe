...
PRECIP_monthly <- Precipitation_long %>% 
  ...
  summarise(MeanPRECIP = mean(Precipitation, na.rm=TRUE),
            MaxPRECIP = max(Precipitation, na.rm=TRUE),
            MinPRECIP = min(Precipitation, na.rm = TRUE))

write.csv(PRECIP_monthly,"./PRECIP_monthly.csv", row.names = FALSE)
```
Oct 2010 - May 2011 [mean, min, max] [INCOMPLETE- make sure that the correct year and month for the summer planting season] [-06,-07,-08,-09] [2011: 01,02,03,04,05    2010: 10,11,12]
```{r}
PRECIP_Summer_2010_2011 <- PRECIP_monthly %>% 
...
```{r}
PRECIP_Summer_2011_2012 <- PRECIP_monthly %>% 
  filter(Year == 2011| Year == 2012) %>% 
  
  filter(!(Year == 2011 & Month == "01")) %>%
  filter(!(Year == 2011 & Month == "02")) %>%
  filter(!(Year == 2011 & Month == "03")) %>%
  filter(!(Year == 2011 & Month == "04")) %>%
  filter(!(Year == 2011 & Month == "05")) %>%
  filter(!(Year == 2011 & Month == "06")) %>%
  filter(!(Year == 2011 & Month == "07")) %>%
  filter(!(Year == 2011 & Month == "08")) %>%
  filter(!(Year == 2011 & Month == "09")) %>%
...
PRECIP_Summer_2016_2017 <- PRECIP_monthly %>% 
...
Oct 2017 -> May 2018 [mean, min, max]
```{r}

PRECIP_Summer_2017_2018 <- PRECIP_monthly %>% 
  filter(Year == 2017 | Year == 2018) %>% 
  
  filter(!(Year == 2017 & Month == "01")) %>%
  filter(!(Year == 2017 & Month == "02")) %>%
  filter(!(Year == 2017 & Month == "03")) %>%
  filter(!(Year == 2017 & Month == "04")) %>%
  filter(!(Year == 2017 & Month == "05")) %>%
  filter(!(Year == 2017 & Month == "06")) %>%
  filter(!(Year == 2017 & Month == "07")) %>%
  filter(!(Year == 2017 & Month == "08")) %>%
  filter(!(Year == 2017 & Month == "09")) %>%
...
```{r}
'PRECIP_monthly_2011-2017' <- PRECIP_monthly %>% 
...
PRECIP_monthly %>% 
  ...
  gather(Type, Precipitation, MeanPRECIP:MinPRECIP) %>% 
...
MaxMarch
```
Necessary data: Add geometry 
```{r}
PRECIP_Summer_2010_2011 <-  full_join (zim_district, PRECIP_Summer_2010_2011, by = "District")
PRECIP_Summer_2011_2012 <-  full_join (zim_district, PRECIP_Summer_2011_2012, by = "District")
PRECIP_Summer_2016_2017 <-  full_join (zim_district, PRECIP_Summer_2016_2017, by = "District")
PRECIP_Summer_2017_2018 <-  full_join (zim_district, PRECIP_Summer_2017_2018, by = "District")

write.csv(PRECIP_Summer_2010_2011, "./PRECIP_Summer_2010_2011.csv", row.names = FALSE)
write.csv(PRECIP_Summer_2011_2012, "./PRECIP_Summer_2011_2012.csv", row.names = FALSE)
write.csv(PRECIP_Summer_2016_2017, "./PRECIP_Summer_2016_2017.csv", row.names = FALSE)
write.csv(PRECIP_Summer_2017_2018, "./PRECIP_Summer_2017_2018.csv", row.names = FALSE)
...
```{r}
#Visualization:                Growing season Oct 2010 -> May 2011 [Mean] 



#2010-2011
SummerPRECIP_2010_2011_MeanMap <- PRECIP_Summer_2010_2011 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MeanPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  facet_wrap(~Month) +
  ggtitle("Summer Growing Season: Oct 2010 - May 2011")

SummerPRECIP_2010_2011_MeanMap
#-------------------------------------------------------------------------------
#Visualization:                Growing season Oct 2011 -> May 2012 [Mean] 



#2011-2012
SummerPRECIP_2011_2012_MeanMap <- PRECIP_Summer_2011_2012 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MeanPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  facet_wrap(~Month) +
  ggtitle("Summer Growing Season: Oct 2011 - May 2012")

SummerPRECIP_2011_2012_MeanMap


#-------------------------------------------------------------------------------
#Visualization:                Growing season Oct 2016 -> May 2017 [Mean] 



#2016-2017
SummerPRECIP_2016_2017_MeanMap <- PRECIP_Summer_2016_2017 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MeanPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  facet_wrap(~Month) +
  ggtitle("Summer Growing Season: Oct 2016 - May 2017")

SummerPRECIP_2016_2017_MeanMap



#-------------------------------------------------------------------------------
#Visualization:                Growing season Oct 2017 -> May 2018 [Mean] 



#2017-2018
SummerPRECIP_2017_2018_MeanMap <- PRECIP_Summer_2017_2018 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MeanPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  facet_wrap(~Month) +
  ggtitle("Summer Growing Season: Oct 2017 - May 2018")

SummerPRECIP_2017_2018_MeanMap
```

```{r}
#Visualization:                Growing season Oct 2010 -> May 2011 [Min] 



#2010-2011
SummerPRECIP_2010_2011_MinMap <- PRECIP_Summer_2010_2011 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MinPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  facet_wrap(~Month) +
  ggtitle("Summer Growing Season: Oct 2010 - May 2011")

SummerPRECIP_2010_2011_MinMap

#-------------------------------------------------------------------------------
#Visualization:                Growing season Oct 2011 -> May 2012 [Min] 



#2011-2012
SummerPRECIP_2011_2012_MinMap <- PRECIP_Summer_2011_2012 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MinPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
...
SummerPRECIP_2011_2012_MinMap
#-------------------------------------------------------------------------------
#Visualization:                Growing season Oct 2016 -> May 2017 [Min] 



#2016-2017
SummerPRECIP_2016_2017_MinMap <- PRECIP_Summer_2016_2017 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MinPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
...
#2016-2017
SummerPRECIP_2017_2018_MinMap <- PRECIP_Summer_2017_2018 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MinPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
...
```{r}
#Visualization:                Growing season Oct 2010 -> May 2011 [Max] 



#2010-2011
SummerPRECIP_2010_2011_MaxMap <- PRECIP_Summer_2010_2011 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MaxPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
  facet_wrap(~Month) +
  ggtitle("Summer Growing Season: Oct 2010 - May 2011")

SummerPRECIP_2010_2011_MaxMap
#-------------------------------------------------------------------------------
#Visualization:                Growing season Oct 2011 -> May 2012 [Max]



#2010-2011
SummerPRECIP_2011_2012_MaxMap <- PRECIP_Summer_2011_2012 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MaxPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
...
SummerPRECIP_2011_2012_MaxMap
#-------------------------------------------------------------------------------
#Visualization:                Growing season Oct 2016 -> May 2017 [Max] 



#2016-2017
SummerPRECIP_2016_2017_MaxMap <- PRECIP_Summer_2016_2017 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MaxPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
...
SummerPRECIP_2016_2017_MaxMap

#-------------------------------------------------------------------------------
#Visualization:                Growing season Oct 2017 -> May 2018 [Max] 



#2017-2018
SummerPRECIP_2017_2018_MaxMap <- PRECIP_Summer_2017_2018 %>% 
  ggplot() +
  geom_sf(size = 0.05, color = "black", aes(fill = MaxPRECIP)) +
  coord_sf() +
  scale_fill_viridis_c(option = "G", direction = -1) +
